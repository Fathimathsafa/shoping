...
import 'package:shoping/sign_inprovider5.dart';

import '3rdpage.dart';
// void main (){
//    runApp(MaterialApp(debugShowCheckedModeBanner: false,
//    home: Login_PageProviderEX(),));
//  }
class Login_PageProviderEX extends StatelessWidget {
  Login_PageProviderEX({super.key});
      ...
      body:Center(
        child: Stack(
          children: [
            ...
            Positioned(
                top: 10,left: 50,
                child: Text("Login",style: TextStyle(color: Color(0xFFDFCAA0),fontWeight: FontWeight.bold,fontSize: 40),)),
            ...
            Positioned(
              ...
              MaterialButton(onPressed: (){},
                  ...
                  height: 50,
                  minWidth: 70,
                  child: Text("Login",style: TextStyle(color:Color(0xFFDFCAA0),fontWeight: FontWeight.bold ),)),
            ),
            Positioned(
              bottom: 40,left: 30,right: 30,
              child: TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>sign_PageProviderEX()));
                  },
                  child:
                  RichText(
                      ...
                      text: TextSpan(
                          ...
                          children: [
                            TextSpan(text: "don't have an account?",style: TextStyle(color: Color(0xFF795548),fontSize: 15)),
                            TextSpan(
                                text: "sign up",
